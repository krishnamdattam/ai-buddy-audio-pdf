...
const AnimatedLoadingSkeleton = () => {
    ...
    return (
        <motion.div
            className="w-full max-w-4xl mx-auto p-6 bg-gray-800/50 rounded-xl shadow-lg border border-gray-700"
            variants={frameVariants}
            initial="hidden"
            animate="visible"
        >
            <div className="relative overflow-hidden rounded-lg bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {[...Array(config.numCards)].map((_, i) => (
                        <motion.div
                            ...
                            className="bg-gray-800/80 rounded-lg shadow-sm p-4 border border-gray-700/50"
                        >
                            {/* Card placeholders */}
                            <motion.div
                                className="h-32 bg-gray-700/50 rounded-md mb-3"
                                animate={{
                            ...
                            />
                            <motion.div
                                className="h-3 w-3/4 bg-gray-700/50 rounded mb-2"
                                animate={{
                                    background: ["#1f2937", "#374151", "#1f2937"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
                            />
                            <motion.div
                                className="h-3 w-1/2 bg-gray-700/50 rounded"
                                animate={{
                                    background: ["#1f2937", "#374151", "#1f2937"],
                                }}
                                transition={{ duration: 1.5, repeat: Infinity }}
